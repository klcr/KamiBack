...
2. **ガイドラインの参照**: 変更対象に応じて以下のガイドラインを参照する。
   - `domain/` 配下の変更: [CLAUDE.md](../../CLAUDE.md) のガードレール②③ + [domain/CLAUDE.md](../../domain/CLAUDE.md)
   - `api/` 配下の変更: [CLAUDE.md](../../CLAUDE.md) のガードレール②③ + [api/CLAUDE.md](../../api/CLAUDE.md)
   - `web/` 配下の変更: [CLAUDE.md](../../CLAUDE.md) のガードレール②③ + [web/CLAUDE.md](../../web/CLAUDE.md)
